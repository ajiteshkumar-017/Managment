  ...
  {/* Previous */}
    ...
    "
                >
                    ...
                    <div className=' mt-6 p-2 gap-4 grid grid-cols-8 bg-zinc-600 rounded-xl'>
                       {
                       ["Sl.No", "Title",, "Type" ,"Audience", "Published Date", "ExpiryDate", "Status", "Action"].map((heading, index) => 
                    
                    (
                        <div key={index} className='gap-4 text-slate-200 uppercase justify-center items-center text-center wrap-break-word text-sm  font-bold p-1 '>
                            {heading}
                        </div>
                    )
                    )
                            ...
                            (
                                <div key={i} className='grid grid-cols-8 text-black text-center p-2'>
                                    ...
                                    <div className='flex items-center justify-center m-1 gap-3'>
                                        <button className='flex items-center justify-between gap-2 bg-slate-300 p-2 rounded-full hover:bg-slate-100 cursor-pointer '>
                                            <Eye size={18}/>
                                            
                                        </button>

                                        <button className='flex items-center justify-between gap-2 bg-green-300 p-2 rounded-full hover:bg-green-300 cursor-pointer '>
                                            <Pen size={18}/>
                    ...
                    <div className='h-160 lg:h-120 w-260 bg-white rounded-lg shadow-sm p-4'>
                                                            ...
                                                            <div className='flex flex-col lg:flex-row  p-2 gap-4'>
                                                                ...
                                                                <div className='flex flex-col  w-full lg:w-full'>
                                                                    ...
                                                                    <textarea  placeholder='Enter Subject Name' className=' p-3 mt-2 rounded-xl bg-white shadow-sm text-black border border-slate-200 w-full' />
                                                                </div>
                                                            </div>
