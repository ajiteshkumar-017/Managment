...
// Safely import the map so it never runs on the server
...
function contactUs() {
  const handleSubmit = async (e: React.FormEvent<HTMLButtonElement>) => {
    try {
      ...
      // Removed the broken ': any' syntax to fix the ReferenceError
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="w-full lg:w-1/2 ">
          ...
          >
            <div className="flex justify-between">
              <div className="flex flex-col gap-4 p-2 w-1/2">
                ...
                <input
                  id="firstName"
                  type="text"
                  className="px-4 py-3 focus:ring-2 focus:ring-purple-400 outline-none border border-gray-100 rounded-2xl text-black"
                />
              </div>
              <div className="flex flex-col gap-4 p-2 w-1/2">
                <label
                ...
                <input
                  id="lastName"
                  type="text"
                  className="px-4 py-3 focus:ring-2 focus:ring-purple-400 outline-none border border-gray-100 rounded-2xl shadow-sm text-black"
                />
              </div>
            </div>
            ...
            <div className=" flex flex-col mt-4 p-2 gap-4">
              <button
                type="submit"
                className="p-2 bg-amber-400 rounded-3xl text-black font-bold cursor-pointer hover:scale-95 transition-all duration-300"
      ...
      <div>
        <h2 className="text-3xl text-black m-4 tracking-tighter font-bold p-4">
          Campus map
        </h2>
      </div>
      <div className="p-4">
      ...
      <div className="m-4 p-6 bg-white border border-gray-200 rounded-2xl">
        <h2 className="text-2xl font-bold mb-6 text-black flex items-center gap-2">
          <span className="w-2 h-8 bg-amber-400 rounded-full"></span> Important
          Helplines
        </h2>
